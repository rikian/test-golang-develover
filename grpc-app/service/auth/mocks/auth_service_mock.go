...
// Source: grpc-app/service/auth/auth.go
...
func (m *MockAuthService) LoginUser(arg0 context.Context, arg1 *auth.RequestLogin) (*auth.ResponseLogin, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LoginUser", arg0, arg1)
	ret0, _ := ret[0].(*auth.ResponseLogin)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAuthService) RegisterUser(arg0 context.Context, arg1 *auth.RequestRegister) (*auth.ResponseRegister, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RegisterUser", arg0, arg1)
	ret0, _ := ret[0].(*auth.ResponseRegister)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
